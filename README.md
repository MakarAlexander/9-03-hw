# Домашнее задание к занятию «Система мониторинга Zabbix. Часть 2» "Макарцев Александр Владимирович"
...
#### Решение
![3-1](./9-3-2.png)
Не даёт присоединить к хостам шаблон "Linux by Zabbix agent", т.к. в уже используются items из него в шаблоне Zadanie 2-3:
![3-2](./9-3-3.png)
